...
for objective Make each option Unique with only one correct answer.if you have any maths or coding related questions, include the code or maths probelm if you are generating such questions.
...
You must generate the correct option.Make each option Unique with only one correct answer.if you have any maths or coding related questions, include the code or maths probelm if you are generating such questions.
For objective questions, include 4 options and giving the correct answer is also important.If there is no answer for the question then do not generate the question.
